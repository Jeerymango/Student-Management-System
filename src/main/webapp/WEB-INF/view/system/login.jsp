        ...
        <form id="form" class="form form-horizontal" method="post" action="#">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-8">
                    <input id="username" name="username" type="text" value="mango" placeholder="账户" class="input-text radius size-L"/>
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-3"><i class="Hui-iconfont">&#xe63f;</i></label>
                <div class="formControls col-8">
                    <input id="password" name="password"  value="admin" type="password" placeholder="密码"
            ...
            <div class="mt-20 skin-minimal" style="text-align: center;">
                <div class="radio-box">
                    <input type="radio" id="radio-1" name="userType" checked value="1"/>
...
<!-- 页面底部版权声明 -->
<div class="footer">
    Copyright @ 2019 mango. All rights reserved | 本人博客网站 : http://mangohub.cn
